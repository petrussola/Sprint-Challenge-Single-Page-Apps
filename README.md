...
> Answer: Client side routing means that the logic to connect and navigate through pages of your app is set client side, using java script. Using this approach pages are rendered without network requests to the server.
